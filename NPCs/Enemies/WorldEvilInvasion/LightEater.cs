...
namespace Polarities.NPCs.Enemies.WorldEvilInvasion
{
    public class LightEater : ModNPC
    {
        ...
        private void SwapWithRandomClone(bool mustBeCloserToPlayer = false, bool mustHaveMinDist = false)
        {
        ...
        private bool[] shadowCloneActive;
        private Vector2[] shadowClonePosition;
        private Vector2[] shadowCloneVelocity;
        private float[] shadowCloneRotation;
