...
namespace Polarities.NPCs
{
    ...
    public class PolaritiesNPC : GlobalNPC
    {
        ...
        public override void Load()
        {
            ...
            // TODO: Make these hooks load again when they work
        ...
        public override void ModifyHitByProjectile(NPC npc, Projectile projectile, ref NPC.HitModifiers modifiers)
        {
            ...
            {
                modifiers.SourceDamage += spiritBiteLevel;
                modifiers.FlatBonusDamage += whipTagDamage;
            }
        }
        ...
        {
            modifiers.ScalingBonusDamage += neutralTakenDamageMultiplier;
            modifiers.CritDamage.Flat += ignoredDefenseFromCritAmount;

            modifiers.Defense *= defenseMultiplier;

            int hammerDefenseLoss = 0;
            foreach (int i in hammerTimes.Keys) {
                if (i > hammerDefenseLoss && hammerTimes[i] > 0) {
                    hammerDefenseLoss = i;
                }
            }

            modifiers.Defense -= hammerDefenseLoss;

            modifiers.Defense -= boneShards;
        }
    }
}
