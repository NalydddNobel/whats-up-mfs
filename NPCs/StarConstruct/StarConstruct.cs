...
namespace Polarities.NPCs.StarConstruct
{
    ...
    public class StarConstruct : ModNPC
    {
        ...
        private SoundStyle Roar => Polarities.AprilFools ? (new SoundStyle("Terraria/Sounds/Roar_2") { Volume = 1f, Pitch = 0.7f }) : Sounds.StarConstructRoar;

        private SoundStyle Scream => Polarities.AprilFools ? (new SoundStyle("Terraria/Sounds/Roar_2") { Volume = 1f, Pitch = 0.7f }) : Sounds.StarConstructScream;
        ...
        private static int baseArmCount => Main.getGoodWorld ? 6 : 4;
    ...
    internal class DormantConstruct : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[0] == 1)
            {
                ...
                {
                    NPC.active = false;
                    NPC.NewNPC(NPC.GetSource_FromAI(), (int)NPC.Center.X, NPC.Hitbox.Bottom, NPCType<StarConstruct>());
                }
            }
