...
using Polarities.Items.Armor.FractalArmor;
using Polarities.Items.Accessories;

namespace Polarities.Items.Armor.SelfsimilarArmor
{
	...
	public class SelfsimilarBreastplate : ModItem
	{
		...
		public override void UpdateEquip(Player player)
		{
			...
			player.GetModPlayer<PolaritiesPlayer>().fractalSubworldDebuffResistance += FractalSubworld.POST_SENTINEL_TIME * 4 / 10;
		}

		public override void AddRecipes()
		{
			Recipe recipe = CreateRecipe();
			recipe.AddIngredient<SelfsimilarBar>(24);
			recipe.AddIngredient<FractalBreastplate>();
			recipe.AddTile<FractalAssemblerTile>();
			recipe.Register();
		}
	}
	...
	public class SelfsimilarGreaves : ModItem
	{
		...
		public override void UpdateEquip(Player player)
		{
			...
			player.GetModPlayer<PolaritiesPlayer>().fractalSubworldDebuffResistance += FractalSubworld.POST_SENTINEL_TIME * 3 / 10;
		}

		public override void AddRecipes()
		{
			Recipe recipe = CreateRecipe();
			recipe.AddIngredient<SelfsimilarBar>(18);
			recipe.AddIngredient<FractalGreaves>();
			recipe.AddTile<FractalAssemblerTile>();
			recipe.Register();
		}
	}
	...
	public class SelfsimilarHelmetMelee : ModItem/*, IVanityMaskRender*/
	{
		public override void SetStaticDefaults()
		{
			base.SetStaticDefaults();
		...
		{
			Recipe recipe = CreateRecipe();
			recipe.AddIngredient<SelfsimilarBar>( 12);
			recipe.AddIngredient<FractalHelmetMelee>();
			recipe.AddTile<FractalAssemblerTile>();
			recipe.Register();
		}
		...
		//public void Render(Player drawPlayer, PlayerDrawSet drawInfo, PlayerDrawLayer layerInfo)
		//{
		...
		//	//Main mask needs to be offset a little because vanilla spritesheet size limitations
		//	Texture2D texture = ModContent.GetTexture(Texture + "_Head");

		//	float drawX = (int)drawInfo.Position.X + drawPlayer.width / 2;
		//	float drawY = (int)drawInfo.Position.Y + drawPlayer.height - drawPlayer.bodyFrame.Height / 2 + 4f - 2f * drawPlayer.gravDir;
		//	Vector2 origin = drawInfo.bodyVect;
		//	Vector2 position = new Vector2(drawX, drawY) + drawPlayer.bodyPosition - Main.screenPosition;

		//	float alpha = (255 - drawPlayer.immuneAlpha) / 255f;
		//	Color color = drawInfo.colorArmorHead * drawPlayer.stealth;
		...
		//	//glowmask
		//	texture = ModContent.GetTexture(Texture + "_Head_Glow");

		//	color = Color.White * drawPlayer.stealth;

		//	drawData = new DrawData(texture, position, frame, color * alpha, rotation, origin, 1f, spriteEffects, 0);
		//	drawData.shader = drawInfo.cHead;
		//	Main.playerDrawData.Add(drawData);
		//}
	}
	...
	[AutoloadEquip(EquipType.Head)]
	public class SelfsimilarHelmetRanger : ModItem/*, IVanityMaskRender*/
	{
		public override void SetStaticDefaults()
		{
			base.SetStaticDefaults();
		...
		public override void AddRecipes()
		{
			Recipe recipe = CreateRecipe();
			recipe.AddIngredient<SelfsimilarBar>( 12);
			recipe.AddIngredient(ItemType<Items.Armor.FractalArmor.FractalHelmetRanger>());
			recipe.AddTile<FractalAssemblerTile>();
			recipe.Register();
		}
		...
		//public void Render(Player drawPlayer, PlayerDrawSet drawInfo, PlayerLayer layerInfo)
		//{
		//	// We don't want the glowmask to draw if the player is cloaked or dead
		//	if (drawInfo.shadow != 0f || drawInfo.drawPlayer.dead)
		//	{
		...
		//	Texture2D texture = ModContent.GetTexture(Texture + "_Head_Glow");
	...
	[AutoloadEquip(EquipType.Head)]
	public class SelfsimilarHelmetMage : ModItem/*, IVanityMaskRender*/
	{
		public override void SetStaticDefaults()
		{
			base.SetStaticDefaults();
		...
		public override void AddRecipes()
		{
			Recipe recipe = CreateRecipe();
			recipe.AddIngredient<SelfsimilarBar>( 12);
			recipe.AddIngredient(ItemType<Items.Armor.FractalArmor.FractalHelmetMage>());
			recipe.AddTile<FractalAssemblerTile>();
			recipe.Register();
		}
	...
	[AutoloadEquip(EquipType.Head)]
	public class SelfsimilarHelmetSummoner : ModItem/*, IVanityMaskRender*/
	{
		public override void SetStaticDefaults()
		{
			base.SetStaticDefaults();
		...
		public override void AddRecipes()
		{
			Recipe recipe = CreateRecipe();
			recipe.AddIngredient<SelfsimilarBar>( 12);
			recipe.AddIngredient<FractalHelmetSummoner>();
			recipe.AddTile<FractalAssemblerTile>();
			recipe.Register();
		}
	...
	public class SelfsimilarSummonerOrb : ModProjectile
	{
		...
		public override void AI()
		{
			...
			int targetID = Projectile.FindTargetWithLineOfSight(1600f);
			if (targetID != -1)
			{
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			Projectile.NewProjectile(
				...
				Projectile.Center, 
				new Vector2(Main.rand.NextFloat(4, 8), 0).RotatedByRandom(MathHelper.TwoPi), 
				ProjectileType<SentinelHeartWisp>(), 
				Projectile.damage / 2, 
				2f, 
				Projectile.owner, ai1: Main.rand.Next(1000));
		}
	...
	public class SelfsimilarMeleeShield : ModProjectile
	{
		...
		public override void ModifyHitNPC(NPC target, ref NPC.HitModifiers modifiers)
		{
			modifiers.Knockback *= Math.Min(Math.Abs(Projectile.velocity.X), 8);
		}
		...
		public override void AI()
		{
			...
			switch (Projectile.ai[0])
			{
				...
				case 1:
                    ...
                    {
						Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity / 2f, ProjectileType<SelfsimilarMagicSwordMini>(), Projectile.damage / 2, 2f, Projectile.owner, ai0: Projectile.ai[1]);
					}
					break;
			}
		}
	...
	public class SelfsimilarMagicSwordMini : ModProjectile
	{
		...
		public override void AI()
		{
			...
			var target = Projectile.FindTargetWithinRange(750f);
			if (target != null)
			{
				Vector2 goalPosition = target.Center;
...
namespace Polarities {
	partial class PolaritiesPlayer {
