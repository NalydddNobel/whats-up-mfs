...
namespace Polarities.Items.Armor.FractalArmor
{
	...
	public class FractalBreastplate : ModItem
	{
        ...
        public override void AddRecipes()
		{
			...
			recipe.AddIngredient<FractalBar>(24);
			recipe.AddIngredient<FractalResidue>(4);
	...
	public class FractalGreaves : ModItem
	{
		...
		{
			Recipe recipe = CreateRecipe();
			recipe.AddIngredient<FractalBar>(18);
			recipe.AddIngredient<FractalResidue>(4);
			recipe.AddTile<FractalAssemblerTile>();
			recipe.Register();
		}
	...
	public class FractalHelmetMelee : ModItem/*, IVanityMaskRender*/
	{
		public override void SetStaticDefaults()
		{
		...
		{
			Recipe recipe = CreateRecipe();
			recipe.AddIngredient<FractalBar>(12);
			recipe.AddIngredient(ItemType<FractalResidue>(), 4);
			recipe.AddTile<FractalAssemblerTile>();
			recipe.Register();
		}
	...
	[AutoloadEquip(EquipType.Head)]
	public class FractalHelmetRanger : ModItem/*, IVanityMaskRender*/
	{
		public override void SetStaticDefaults()
		{
	...
	[AutoloadEquip(EquipType.Head)]
	public class FractalHelmetMage : ModItem/*, IVanityMaskRender*/
	{
		public override void SetStaticDefaults()
		{
	...
	[AutoloadEquip(EquipType.Head)]
	public class FractalHelmetSummoner : ModItem/*, IVanityMaskRender*/
	{
		public override void SetStaticDefaults()
		{
