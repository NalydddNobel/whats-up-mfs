...
{
    public abstract class ChestBase : ModItem
    {
    ...
    public abstract class ChestTileBase : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(MapColorLocked, Language.GetText($"Mods.Polarities.MapObject.{Name}_Locked"));
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            else
            {
                if (isLocked)
                {
                    if (UnlockItem != -1)
                    {
                        if (player.ConsumeItem(UnlockItem) && Chest.Unlock(left, top))
                        {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                if (player.cursorItemIconText == ChestName)
                {
                    ...
                    {
                        player.cursorItemIconID = UnlockItem;
                    }
