...
namespace Polarities.Projectiles
{
    public class PolaritiesProjectile : GlobalProjectile
    {
        ...
        private static int On_Main_GetProjectileDesiredShader(On_Main.orig_GetProjectileDesiredShader orig, Projectile proj) {
            if (proj.GetGlobalProjectile<PolaritiesProjectile>().customShader != 0) {
                return proj.GetGlobalProjectile<PolaritiesProjectile>().customShader;
            }
